...
const LotteryInterface = () => {
  ...
  const handleNumberSelection = (tableIndex:number, number:number, isStrong = false) => {
  ...
  const clearTableRow = (tableIndex:number) => {
    const newTables = [...tables];
  ...
  const RightColumn = () => {
    ...
    const getNumberButtonClass = (number:number, isStrong = false) => {
